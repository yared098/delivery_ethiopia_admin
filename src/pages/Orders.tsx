...
// Statuses where order can't be hard-deleted (must cancel instead)
const DELETE_BLOCKED: OrderStatus[] = [
  OrderStatus.PICKED_UP,
  OrderStatus.IN_TRANSIT,
  OrderStatus.OUT_FOR_DELIVERY,
  OrderStatus.DELIVERED,
...
export function Orders() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success(`Order ${deleteTarget.trackingNumber} deleted`);
  ...
  return (
    <div className="p-8">
            ...
            <table className="w-full">
              ...
              <tbody>
                {orders.map((o) => {
                  ...
                  const canUnassign =
                    o.courier && !UNASSIGN_BLOCKED.includes(o.status);
                  const canDelete = !DELETE_BLOCKED.includes(o.status);
                        ...
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <button
                            ...
                            title={
                              canDelete
                                ? 'Delete order'
                                : 'Cannot delete — order is in motion'
                            }
                          >
      ...
      <ConfirmDialog
        ...
        title="Delete Order"
        message={`Permanently delete order ${
          deleteTarget?.trackingNumber || ''
        }? This removes the order, its items, events, links, and payments. This cannot be undone.`}
